...
namespace BWEM {
	...
	Neutral::Neutral(BWAPI::Unit u, BWEMMap *pMap)
	...
	Ressource::Ressource(BWAPI::Unit u, BWEMMap *pMap)
		: Neutral(u, pMap),
	...
	Mineral::Mineral(BWAPI::Unit u, BWEMMap *pMap)
		: Ressource(u, pMap)
	{
	...
	Geyser::Geyser(BWAPI::Unit u, BWEMMap *pMap)
		: Ressource(u, pMap)
	{
	...
	StaticBuilding::StaticBuilding(BWAPI::Unit u, BWEMMap *pMap) : Neutral(u, pMap)
	{
