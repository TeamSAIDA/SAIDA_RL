...
namespace BWEM {
	...
	protected:
		Neutral(BWAPI::Unit u, BWEMMap *pMap);
		~Neutral();
		BWEMMap *const 					GetMap() const				{
			return m_pMap;
		}
	...
	{
	public:
		Ressource(BWAPI::Unit u, BWEMMap *pMap);
	...
	{
	public:
		Mineral(BWAPI::Unit u, BWEMMap *pMap);
		~Mineral();
	...
	{
	public:
		Geyser(BWAPI::Unit u, BWEMMap *pMap);
		~Geyser();
	...
	{
	public:
		StaticBuilding(BWAPI::Unit u, BWEMMap *pMap);
