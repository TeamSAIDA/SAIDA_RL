...
namespace BWEM {
	...
	altitude_t minAltitudeTop(const TilePosition &tile, const BWEMMap &theMap)
	{
		WalkPosition w(tile);
	...
	altitude_t minAltitudeBottom(const TilePosition &tile, const BWEMMap &theMap)
	{
		WalkPosition w(tile);
	...
	altitude_t minAltitudeLeft(const TilePosition &tile, const BWEMMap &theMap)
	{
		WalkPosition w(tile);
	...
	altitude_t minAltitudeRight(const TilePosition &tile, const BWEMMap &theMap)
	{
		WalkPosition w(tile);
