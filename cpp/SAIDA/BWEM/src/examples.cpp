...
namespace BWEM {
	...
	namespace utils
	{
		...
		void drawMap(const BWEMMap &theMap)
		{
		...
		static void printNeutral(const BWEMMap &theMap, const Neutral *n, MapPrinter::Color col)
		{
		...
		void printMap(const BWEMMap &theMap)
		{
		...
		void pathExample(const BWEMMap &theMap)
		{
		...
		{
		public:
			SimpleGridMap(const BWEMMap *pMap) : GridMap(pMap) {}
		...
		void gridMapExample(const BWEMMap &theMap)
		{
