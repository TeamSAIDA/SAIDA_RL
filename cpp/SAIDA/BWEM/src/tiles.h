...
namespace BWEM {
	...
	altitude_t minAltitudeTop(const BWAPI::TilePosition &tile, const BWEMMap &theMap);
	altitude_t minAltitudeBottom(const BWAPI::TilePosition &tile, const BWEMMap &theMap);
	altitude_t minAltitudeLeft(const BWAPI::TilePosition &tile, const BWEMMap &theMap);
	altitude_t minAltitudeRight(const BWAPI::TilePosition &tile, const BWEMMap &theMap);
