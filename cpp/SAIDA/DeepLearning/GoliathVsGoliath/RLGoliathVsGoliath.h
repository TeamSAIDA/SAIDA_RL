...
namespace BWML {
	class RLGoliathVsGoliath : public Gym
	{
	private:
	...
	public:
		RLGoliathVsGoliath(string shmName, ConnMethod method = SHARED_MEMORY) : Gym("RLGoliathVsGoliath") {
			connection = new RLSharedMemory(shmName, 2000000);
			connection->initialize();
		}
		~RLGoliathVsGoliath() { };

		static RLGoliathVsGoliath &Instance(string shmName = "");
