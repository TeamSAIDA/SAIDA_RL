...
namespace BWEM
{
	...
	namespace utils
	{
		...
		public:
			...
			ExampleWall(const BWEMMap &theMap, const ChokePoint *cp, tight_t tight = tight_t::zealot);
		...
		std::vector<ExampleWall> findWalls(const BWEMMap &theMap);
